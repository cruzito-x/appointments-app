      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-4 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex md:w-2/3 sm:w-full max-w-4xl flex-col md:flex-row">
          <div className="md:w-3/5 w-full p-5">
            ...
            <div className="py-10">
              ...
              <form onSubmit={login} className="flex flex-col items-center">
                ...
                <button
                  type="submit"
                  className="mt-3 border-2 border-blue-500 text-blue-500 rounded px-8 py-2 inline-block font-semibold hover:bg-blue-500 hover:text-white transition duration-300"
                >
                  Iniciar Sesión
                </button>
              </form>
          ...
          <div className="md:w-2/5 w-full bg-blue-500 text-white rounded-tr-2xl md:rounded-br-2xl rounded-bl-2xl md:rounded-bl-none py-20 px-12 flex flex-col items-center">
            ...
            <a
              className="mb-16 border-2 border-white rounded px-5 py-2 inline-block font-semibold hover:bg-white hover:text-blue-500 transition duration-300"
              href="#"
            >
